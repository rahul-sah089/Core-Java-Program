...
public class RegexMetaData {
	public static void main(String[] args){
		...
		System.out.println(Pattern.matches("\\D", "abc"));  //false(non-digit but comes more then once)
		System.out.println(Pattern.matches("\\D+", "abc"));  //true(non-digit and comes more then once)
		System.out.println(Pattern.matches("\\D+", "adasd12"));  //false
